...
scripts/
  ...
  gen-component.cjs       시맨틱 → 컴포넌트 37종 + 1,002 검사
  perturb.cjs / presets.cjs  섭동 매트릭스 6프리셋 × 1,002 = 6,012 검사
...
node scripts/gen-component.cjs          # 1,002 검사
node scripts/perturb.cjs                # 6,012 검사 (엔진 적응)
