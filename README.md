...
scripts/
  ...
  gen-component.cjs       시맨틱 → 컴포넌트 18종 + 443 검사
  perturb.cjs / presets.cjs  섭동 매트릭스 6프리셋 × 443 = 2,658 검사
...
node scripts/gen-component.cjs          # 443 검사
node scripts/perturb.cjs                # 2,658 검사 (엔진 적응)
