...
scripts/
  ...
  gen-component.cjs       시맨틱 → 컴포넌트 20종 + 558 검사
  perturb.cjs / presets.cjs  섭동 매트릭스 6프리셋 × 558 = 3,348 검사
...
node scripts/gen-component.cjs          # 558 검사
node scripts/perturb.cjs                # 3,348 검사 (엔진 적응)
